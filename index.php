...
<head>
    ...
    <title>Petroleum products Booking </title>
...
<body>
    ...
    <div class="container">
        <div class="navbar-header"><a href="index.php" class="navbar-brand navbar-link"><i class="glyphicon glyphicon-fire text-info"></i>Petroleum products Booking Portal</a>
...
<!--
        ...
        <div class="carousel slide" data-ride="carousel" id="carousel-1">
            <div class="carousel-inner" role="listbox">
                <div class="item active"><img style=" margin: 0 auto;" src="assets/img/tanker3.jpg" alt="First Image"></div>
				<div class="item"><img style=" margin: 0 auto;" src="assets/img/oiltanker.png" width="992px" height="400px" alt="Second Image"></div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
					...
					<iframe class="gmap_iframe" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?width=600&amp;height=400&amp;hl=en&amp;q=machakos &amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"></iframe><a href="https://www.kokagames.com/fnf-friday-night-funkin-mods/">Machakos area</a></div><style>.mapouter{position:relative;text-align:right;width:600px;height:360px;}.gmap_canvas {overflow:hidden;background:none!important;width:600px;height:360px;}.gmap_iframe {width:600px!important;height:360px!important;}</style>
					</br>
